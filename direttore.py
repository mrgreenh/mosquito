...
class Direttore:
    ...
    def store_instrument(self,metadata):
        item = {}
        for key in metadata:
            item[key] = metadata[key]
            
        self.instruments[metadata.get('user',"anonymous")] = item
        return str(item)
    
    def get_instruments(self):
        print(str(self.instruments))
        for inst in self.instruments:
            self.instruments[inst]["pitch"]=self.quantizePitch(self.instruments[inst]["pitch"]);
            print("----------------------------"+str(self.instruments[inst]["pitch"]))
