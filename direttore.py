...
class Direttore:
    ...
    def __init__(self):
        ...
        self.scala_notes = self.set_scala("C");
        self.instruments = {}
        
    def set_scala(self, scale):
        if scale=="C":
            self.scala_notes = ['A4','B4','C4','D4','E4','F4','G4','A4','B4','C4','D4','E4','F4','G4']
    
    def store_instrument(self,metadata):
        self.instruments[metadata.get('user',"anonymous")] = metadata
        print "RECEIVED: "+str(metadata)
        return str(metadata)
